	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sLengthMenu": "<span class='itemsPerPage'>Registros por P&aacute;gina:</span> _MENU_",
				"sZeroRecords": "No hay registros coincidentes encontrados",
				"sEmptyTable": "No hay datos disponibles en la tabla",
				"sLoadingRecords": "Cargando...",
				"sInfo": "Mostrando _START_ a _END_ de _TOTAL_ registros",
				"sInfoEmpty": "Mostrando 0 a 0 de 0 registros",
				"sInfoFiltered": "(_MAX_ totales registrados)",
				"sInfoPostFix": "",
				"sInfoThousands": ",",
				"sSearch": "<span class='itemsPerPage'>B&uacute;squeda:</span>",
				"sUrl": "",
				"oPaginate": {
					"sFirst":    "Primero",
					"sPrevious": "Anterior",
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  ...
			  sSearchStr==="" ? '<input type="text" />' : sSearchStr+' <input type="text" placeholder="escriba aqu&iacute;..." /><div class="srch"></div>';
