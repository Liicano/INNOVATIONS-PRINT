        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "dateRange": {
                    "regex": "none",
                    "alertText": "* Inválido ",
                    "alertText2": "Intérvalo de Fecha"
                },
                "dateTimeRange": {
                    "regex": "none",
                    "alertText": "* Inválido ",
                    "alertText2": "Período de Tiempo"
                },
                "minSize": {
                    "regex": "none",
                    "alertText": "* Mínimo ",
                ...
                "min": {
                    "regex": "none",
                    "alertText": "* Valor Mínimo is "
                },
                "max": {
                    "regex": "none",
                    "alertText": "* Valor Máximo is "
                },
                "past": {
                    "regex": "none",
                ...
                "phone": {
                    ...
                    "alertText": "* Número de teléfono no válida"
                },
                "cell": {
                    // credit: jquery.h5validate.js / orefalo
                    "regex": /^([\+][0-9]{1,3}[ \.\-])?([\(]{1}[0-9]{2,6}[\)])?([0-9 \.\-\/]{4,20})((x|ext|extension)[ ]?[0-9]{1,4})?$/,
                    "alertText": "* Número de teléfono celular no válida"
                },				
                "email": {
                ...
                "number": {
                    ...
                    "regex": /^[\-\+]?(([0-9]+)([\.,]([0-9]+))?|([\.,]([0-9]+))?)$/,
                    "alertText": "* No es un número con decimal válido"
                },
                "date": {
                ...
                "onlyLetterNumber": {
                    ...
                    "alertText": "* Sin caracteres especiales permitidos"
                },
                ...
                "ajaxUserCall": {
                    ...
                    "alertTextLoad": "* Validación, por favor espere"
                },
				"ajaxUserCallPhp": {
