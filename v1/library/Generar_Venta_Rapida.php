...
class Generar_Venta_Rapida extends TCPDF
{
	...
	function Generar_Venta ($desde, $hasta, $mensaje="" )
	{

		$pdf = new Generar_Venta_Rapida('P', 'mm', 'LETTER', false, 'ISO-8859-1', false);		
		...
		$pdf->SetTitle('INNOVATIONS PRINT Venta');
		...
		$html = '<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:12px;">
					...
					<tr>
						...
						<td width="18%" align="left">Venta N&deg;:</td>
		...
		$pdf->Output('../../tmp/Factura_Innovations_Print_'.$mensaje[0].'_'.$desde.'.pdf', 'F');
