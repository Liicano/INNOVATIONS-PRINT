	...
	<div class="wrapper">
		...
		<div class="nNote nInformation hideit">
			<p>
				<strong>INFORMACI&Oacute;N: </strong>Llenar los campos correspondiente para Editar Abono
			</p>
		</div>
		<!-- Validation form -->
		<form id="validate" class="form" method="post" action="javascript:Actualizar_Abono()">
			<fieldset>
				<div class="widget">
					<div class="title">
						<img src="public/images/icons/dark/alert.png" alt="" class="titleIcon"/>
						<h6>Llenar todos los campos para Editar Abono</h6>
					</div>
					<div class="formRow">
					...
					<div class="formRow">
						...
						<div class="formRight">
							<input type="text" value="" class="validate[custom[number]]" name="txtNumeroTransaccion" id="txtNumeroTransaccion" readonly="readonly"/>
						</div>
						<div class="clear">
						</div>
					</div>					
					<div class="formRow">
						<label>Monto Abonado:<span class="req">*</span></label>
						<div class="formRight">
					...
					<div class="formSubmit">
						<input type="submit" value="Editar Abono" class="redB"/>
						<input type="button" value="Cancelar Ingresar Abono" class="redB" onclick="Cancelar_Editar_Abono()"/>
					</div>
					<div class="clear">
					</div>
				</div>
