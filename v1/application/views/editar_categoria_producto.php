	...
	<div class="wrapper">
		...
		<div class="nNote nInformation hideit">
			<p>
				<strong>INFORMACI&Oacute;N: </strong>Llenar los campos correspondiente para Editar Categor&iacute;a de Producto
			</p>
		</div>
		<!-- Validation form -->
		<form id="validate" class="form" method="post" action="javascript:Actualizar_Categoria_Producto('<?php echo $_GET['id'] ?>')">
			<fieldset>
				<div class="widget">
					<div class="title">
						<img src="public/images/icons/dark/alert.png" alt="" class="titleIcon"/>
						<h6>Llenar todos los campos para Editar Categor&iacute;a de Producto</h6>
					</div>
					<div class="formRow">
					...
					<div class="formSubmit" id="ActualizarCategoriaProducto">
						<input type="submit" value="Editar Categor&iacute;a de Producto" class="redB"/>&nbsp;&nbsp;
