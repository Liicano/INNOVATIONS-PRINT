		  ...
		  <div class="wrapper">
				<form id="validate" class="form" method="post"  action="javascript:Modificar_Cotizacion()">
					<div class="widget">
					...
					<div class="widget">			
					<div class="title"><img src="public/images/icons/dark/frames.png" alt="" class="titleIcon" /><h6>Editar Cotizaci&oacute;n</h6></div>                          
					...
					<tfoot id="tbTotal" >
							...
							<div class="formSubmit" id="ModificarCotizacion">
								<input type="submit" value="Modificar Cotizaci&oacute;n" class="redB"/>&nbsp;&nbsp;<!--<input type="button" value="Tiene Cotizaci&oacute;n Realizado Anteriormente" class="redB" onclick="Buscar_Cotizacion()"/>!-->
							</div>
							<div class="clear">
							</div>						
