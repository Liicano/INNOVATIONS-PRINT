	...
	<div class="wrapper">
		...
		<!-- Validation form -->
		<form id="validate" class="form" method="post" action="javascript:Agregar_Producto()">
			<fieldset>
				<div class="widget">
					<div class="title">
						<img src="public/images/icons/dark/alert.png" alt="" class="titleIcon"/>
						<h6>Llenar todos los campos para Agregar Producto</h6>
					</div>
					<div class="formRow">
					...
					<div class="formRow" id="NombreProducto">
						...
						<div class="formRight">
							...
							<input type="hidden" name="hidCodigoProducto" id="hidCodigoProducto"/>
						</div>
						<div class="clear">
						</div>
					</div>					
					...
					<div class="formRow" id="Proveedor">
						<label>Proveedor:</label>
						<div class="formRight">
							<input type="text" value="" name="txtProveedor" id="txtProveedor"/>
					...
					<!--<div class="formRow" id="CantExistInicial">
						...
						<div class="formRight">
							<input type="text" value="" class="validate[custom[onlyNumberSp]]" name="txtCantExistInicial" id="txtCantExistInicial"/>
						</div>
						<div class="clear">
						</div>
					</div>!-->					
					...
					<div class="formSubmit">
						<input type="submit" value="Agregar Producto" class="redB"/>
						<input type="button" value="Cancelar Agregar Producto" class="redB" onclick="Cancelar_Agregar_Producto()"/>
					</div>
					<div class="clear">
					</div>
				</div>
