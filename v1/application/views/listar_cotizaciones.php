  ...
  <div class="wrapper">
	...
	<div class="widget">
		...
		<!-- cargar Listado de Cotizaciones -->
			<table cellpadding="0" cellspacing="0" border="0" class="display dTable" id="listado_cotizacion">
				<thead>
					<tr>
						<th style="width:2%">#</th>
						...
						<input type="hidden" id="num_campos" name="num_campos" value="'<?php $nfilas ?>'" />
						<input type="hidden" id="cant_campos" name="cant_campos" value="'<?php $nfilas ?>'" /></th>
						<th style="width:9%">Monto Sub-Total</th>
						<th style="width:9%">Monto ITBM</th>
